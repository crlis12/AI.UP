...
async function testIntegratedReport() {
  console.log('🧪 통합된 report.js KDST 기능 테스트');
  console.log('=' * 60);
  ...
  try {
    ...
    const ragSearchResponse = await axios.post(`${BASE_URL}/report/kdst-rag-search`, {
    ...
    const contextResponse = await axios.post(`${BASE_URL}/report/kdst-report-context`, {
      questions: testQuestions
    });
